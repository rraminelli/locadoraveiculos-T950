...
public class VeiculoServiceImpl implements VeiculoService {
    ...
    @Override
    public void calcularSeguroObrigatorio(Veiculo veiculo) {
        veiculo.setSeguroObrigatorio(new BigDecimal(200));
    }

    @Override
    public void calcularSeguroRoubo(Veiculo veiculo) {
        veiculo.setSeguroRoubo(new BigDecimal(1200));
    }
